...
/* ================= TYPING EFFECT ================= */
const technologies = ["Node.js","TypeScript","Java","PHP","React","PostgreSQL"];
...
const translations = {
  en: {
    ...
    about_text: "I am a Full Stack developer passionate about creating efficient and elegant solutions. I enjoy working with modern technologies and I am always eager to learn new things. My strengths include attention to detail, problem-solving, and teamwork.",
  ...
  pt: {
    ...
    about_text: "Sou um desenvolvedor Full Stack apaixonado por criar soluções eficientes e elegantes. Gosto de trabalhar com tecnologias modernas e sempre busco aprender algo novo. Minhas qualidades incluem atenção aos detalhes, resolução de problemas e trabalho em equipe.",
    skills_title: "Skills",
